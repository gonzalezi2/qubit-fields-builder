      ...
      <div class="field">
        ...
        <div class="valuesInputs">
          <div class="selectWrapper">
            ...
            <svg data-icon-name="PointerDownIcon" class="dropdownIcon" viewBox="0 0 16 16" style="transform: rotate(0deg);"><polygon fill-rule="evenodd" points="3 6 8 11 13 6" /></svg>
          </div>
        </div>
        { field.footnote && <p class="footnote">"footnote"</p> }
      </div>
